      ...
      <div className="col-lg-4">
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <hr/>
            <ul class="fa-ul">
              <li><span className="fa-li"><i class="fas fa-check"></i></span>Single User</li>
              <li><span className="fa-li"><i class="fas fa-check"></i></span>5GB Storage</li>
              ...
              <li className="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Unlimited
                Private Projects</li>
              <li className="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Dedicated
                Phone Support</li>
              <li className="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Free Subdomain
              </li>
              <li className="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Monthly Status
                Reports</li>
            </ul>
        ...
        <div className="card">
          <div className="card-body">
            ...
            <ul className="fa-ul">
              ...
              <li><span className="fa-li"><i class="fas fa-check"></i></span>150GB Storage</li>
              <li><span className="fa-li"><i class="fas fa-check"></i></span>Unlimited Public Projects</li>
              <li><span className="fa-li"><i class="fas fa-check"></i></span>Community Access</li>
              <li><span className="fa-li"><i class="fas fa-check"></i></span>Unlimited Private Projects</li>
              <li><span className="fa-li"><i class="fas fa-check"></i></span>Dedicated Phone Support</li>
              <li><span className="fa-li"><i class="fas fa-check"></i></span><strong>Unlimited</strong> Free
                Subdomains</li>
